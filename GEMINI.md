# Projeto: Plataforma de Gestão Interna - Clínica Daniandrade

Este documento fornece orientações e contexto técnico sobre a plataforma de gestão interna da Clínica Estética Avançada Daniandrade.
